...
class Form {
    ...
    public function validate($fieldsToValidate) {
        ...
        foreach ($fieldsToValidate as $fieldName => $rules) {
            ...
            foreach ($rules as $rule) {
                ...
                $validate = $this->$rule($value, $parameter);
    ...
    /**
     * Returns value if the given value is GREATER THAN OR EQUAL TO the given parameter
     */
    ...
    /**
     * Returns value if the given value is LESS THAN OR EQUAL TO the given parameter
     */
